...
/*   Updated: 2024/12/18 20:01:41 by qhauuy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->r = data->t->pixels[data->tex_y * data->t->width * 4 + \
		data->tex_x * 4];
	data->g = data->t->pixels[data->tex_y * data->t->width * 4 + \
		data->tex_x * 4 + 1];
	data->b = data->t->pixels[data->tex_y * data->t->width * 4 + \
		data->tex_x * 4 + 2];
