...
/*   Updated: 2024/12/19 10:12:16 by hakgyver         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_up(t_data *data)
{
	...
	if (data->map[(int)(new)][(int)(data->pos_y)] != '1' && data->map[(int)(new)][(int)(data->pos_y)] != 'D')
	...
	if (data->map[(int)(data->pos_x)][(int)(new)] != '1' && data->map[(int)(data->pos_x)][(int)(new)] != 'D')
	{
		data->pos_y = new;
